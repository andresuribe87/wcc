...
class PredictionsControllerTest < ActionController::TestCase
  ...
  test "should create prediction" do
    assert_difference('Prediction.count') do
      post :create, prediction: { away_score: @prediction.away_score, home_score: @prediction.home_score, match_id: @prediction.match_id, user_id: @prediction.user_id }
    end
  ...
  test "should update prediction" do
    patch :update, id: @prediction, prediction: { away_score: @prediction.away_score, home_score: @prediction.home_score, match_id: @prediction.match_id, user_id: @prediction.user_id }
    assert_redirected_to prediction_path(assigns(:prediction))
  end
